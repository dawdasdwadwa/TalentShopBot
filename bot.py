            ...
            models = [
                {
                    ...
                    "system": "Ты — Senior Python Developer с 20-летним стажем. Пиши чистый, рабочий код. Отвечай на русском.",
                    "color": 0x00FF00
                },
                {
                    "name": "GPT-OSS 120B",
                    "id": "openai/gpt-oss-120b",
                    "system": "Ты — эксперт по архитектуре ПО и системному дизайну. Давай структурированные ответы. Отвечай на русском.",
                    "color": 0x0099FF
                },
                {
                    "name": "GPT-OSS 20B",
                    "id": "openai/gpt-oss-20b",
                    "system": "Ты — специалист по оптимизации и лучшим практикам. Предлагай эффективные решения. Отвечай на русском.",
                    "color": 0xFF6600
                }
            ]
